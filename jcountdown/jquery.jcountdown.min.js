    ...
    jCountdown: function () {
        var B = function (b) {
            ...
            this.frame = function (a) {
                ...
                this._frame = a;
                var a = -(9 - this.value()) * this.width(), b = -(this.frame() - 1) * this.height();
            ...
            this.checkTime = function (b) {
                ...
                if (!isNaN(this._time)) {
                    ...
                    for (a = 0; a < this._hours.length; a++) d = parseInt(c.shift(), 10), d != this._hours[a].value() && this._hours[a].value(d, b);
                    for (a = 0; a < this._minutes.length; a++) d = parseInt(c.shift(), 10), d != this._minutes[a].value() && this._minutes[a].value(d, b);
                    for (a = 0; a < this._seconds.length; a++) d = parseInt(c.shift(), 10), d != this._seconds[a].value() && this._seconds[a].value(d, b)
                }
                return !1
            };
            ...
            this.timeFormat = function (b, a, c, d, e) {
                var b = Math.floor(b / 1E3), f = b % 60, g = Math.floor(b % 3600 / 60),
            ...
            this.time = function (b, a) {
                this._timeText = b;
                this._timeZone = a;
                var c = this._timeText.split("/").join(" ").split(":").join(" ").split(" "), d = parseInt(c[0], 10),
                    e = parseInt(c[1], 10) - 1, f = parseInt(c[2], 10), g = parseInt(c[3], 10),
                    h = parseInt(c[4], 10) - 60 * this._timeZone, c = parseInt(c[5], 10);
        ...
        if (0 < arguments.length) {
            ...
            if (1 == arguments.length && "object" == typeof arguments[0]) {
                ...
                var j = parseInt(jQuery.browser.version, 10), y = "string" == typeof e.timeText ? e.timeText : "",
                ...
                0 < p || (p = 0);
                var u = !1 != e.reflection, r = parseFloat(e.reflectionOpacity);
                0 < r ? 100 < r && (r = 100) : r = 10;
                var l = parseInt(e.reflectionBlur, 10);
                0 < l ? 10 < l && (l = 10) : l = 0;
                var g = 2 < parseInt(e.dayTextNumber, 10) ? parseInt(e.dayTextNumber, 10) : 2, h = !1 != e.displayDay,
                    A = !1 != e.displayHour, z = !1 != e.displayMinute, x = !1 != e.displaySecond,
                    w = !1 != e.displayLabel, e = "function" == typeof e.onFinish ? e.onFinish : function () {
                    }, c, f = "", s = "";
                ...
                d = 1;
                for (j = ".group.day>.container.item"; g.find(j + d).length;) k.push(new f(g.find(j + d))), d++;
                d = 1;
                for (j = ".group.hour>.container.item"; g.find(j + d).length;) n.push(new f(g.find(j + d))), d++;
                d = 1;
                for (j = ".group.minute>.container.item"; g.find(j + d).length;) p.push(new f(g.find(j + d))), d++;
                d = 1;
                for (j = ".group.second>.container.item"; g.find(j + d).length;) u.push(new f(g.find(j + d))), d++;
                m.items(k, n, p, u);
                m.onFinish = e;
                m.time(y, t)
